...
<!--   team.spotRemaining => means there is spot > 0 -->
<!--   !team.spotRemaining => means there is spot = 0-->
  <p class="text-right text-gray-600 italic" v-show="!team.spotRemaining">There are no remaining team spots. Upgrade to add more.</p>
</template>
